<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active">جدول دوام الموظفين</li>
        </ol>
    </div><!--/.row-->

    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">جدول دوام الموظف</h1>
        </div>
    </div><!--/.row-->
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">دوام الموظف</div>
                <div class="panel-body">
                    ...
                    ?>
                    <p><b>اسم الموظف: </b> <?php echo $employee['emp_name']; ?></p>
                    <p><b>راتب الموظف: </b> <?php echo $employee['salary'].''; ?></p>
                                    ...
                                    <div class="panel-body">
                                        <form data-toggle="validator" role="form" action="functionmis.php"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-lg-6">
                                                    <label>نوع الاقبات الشخصي</label>
                                                ...
                                                <div class="form-group col-lg-6">
                                                    <label>رقم الاثبات الشخصي المقدم</label>
                                            ...
                                            <button type="submit" class="btn btn-lg btn-primary" name="submit">ارسال
                                            </button>
        ...
        <div id="changeShift" class="modal fade" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h4 class="modal-title">تغير وقت العمل</h4>
                    </div>
                    <div class="modal-body">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        <form data-toggle="validator" role="form" action="ajax.php" method="post">
                                            ...
                                            <button type="submit" class="btn btn-lg btn-primary" name="change_shift">ارسال</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
